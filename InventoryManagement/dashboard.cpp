...
void Dashboard::getMTDOrderCost()
{
...
//Written by Bryce Kinney
void Dashboard::getMTDSaleValue()
{
    QSqlQuery saleQuery;
...
//Written by Bryce Kinney
void Dashboard::getOverheadValue()
{
...
//Written by Bryce Kinney
void Dashboard::getOverheadCost()
{
...
//Written by Bryce Kinney
void Dashboard::getOverheadNet()
{
    overheadNet = overheadValue - overheadCost;
}

void Dashboard::getOutOfStockItems()
{
